При выполненении этой задачи я создал в Confluence проект:"Курсовая1". В том проекте был создан тест план проекта. В котором я собрал всю тестовую и отчетную документацию и отразил ход выполненых работ на проекте.
В результате получился проект на котором я :
- 
я разбил основные 5 этапов на более мелкие шаги.

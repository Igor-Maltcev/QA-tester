При выполненении этой задачи я создал в Confluence проект:"Курсовая1". В этом проекте был создан тест план проекта. В котором я собрал всю тестовую и отчетную документацию и отразил ход выполненых работ на проекте.

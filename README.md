...
---
 #### Проект 5: SQL  
 Что нужно было сделать :
 1. Создать базу данных в Postgresgl.
 2. Заполнить ее данными.
 3. Выполнить необходимые запросы.
> [Ссылка на прект](https://www.notion.so/SQL-00f722ecdcc84773b89e777266e3d6d5)
---
#### Проект 6: Тестирование мобильного приложения 
> [Ссылка на проект](https://www.notion.so/81826da2120d4b82a138ff7a9ecfaac2#dd2cfc89a6074a039bf87932fb1e8960)
